	...
	public static void main(String[] args) {
		...
		while (JOptionPane.showOptionDialog(null, "¿Desea ingresar informacion?", "Informacion", siNo2,
			...
			case PROGRAMADOR:
				...
				dia2 = JOptionPane.showInputDialog(null, "Ingrese el dia de nacimiento de el programador", "Fecha de nacimiento", JOptionPane.INFORMATION_MESSAGE);
				dia = Integer.parseInt(dia2);
				mes2 = JOptionPane.showInputDialog(null, "Ingrese el mes de nacimiento de el programador","Fecha de nacimiento", JOptionPane.INFORMATION_MESSAGE);
				mes = Integer.parseInt(mes2);
				año2 = JOptionPane.showInputDialog(null,"Ingrese el año de nacimiento de el programador","Fecha de nacimiento", JOptionPane.INFORMATION_MESSAGE);
				...
				programador = new Programadores(nombre, apellido, sueldoBasicoMensual, horasExtras2, bonoPorHoraExtra2, dia, mes, año, fechaDeNacimiento);
			...
			case VENDEDOR:
				...
				sueldoBasicoMensual2 = JOptionPane.showInputDialog(null, "Ingrese el sueldo del vendedor", "Sueldo",
						JOptionPane.INFORMATION_MESSAGE);
				sueldoBasicoMensual = Integer.parseInt(sueldoBasicoMensual2);
				dia2 = JOptionPane.showInputDialog(null, "Ingrese el dia de nacimiento de el vendedor", "Fecha de nacimiento", JOptionPane.INFORMATION_MESSAGE);
				dia = Integer.parseInt(dia2);
				mes2 = JOptionPane.showInputDialog(null, "Ingrese el mes de nacimiento de el vendedor","Fecha de nacimiento", JOptionPane.INFORMATION_MESSAGE);
				mes = Integer.parseInt(mes2);
				año2 = JOptionPane.showInputDialog(null,"Ingrese el año de nacimiento de el vendedor","Fecha de nacimiento", JOptionPane.INFORMATION_MESSAGE);
				año = Integer.parseInt(año2);
				if (JOptionPane.showOptionDialog(null, "¿Realizo ventas?", "Ventas", ventasSiNo2,
					...
					vendedor = new Vendedores(nombre, apellido, sueldoBasicoMensual, ventas, porcentaje, dia, mes, año, fechaDeNacimiento);
					lista.add(vendedor);
				}
				break;
			}
